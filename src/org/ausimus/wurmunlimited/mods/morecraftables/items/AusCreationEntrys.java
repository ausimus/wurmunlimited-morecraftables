...
public class AusCreationEntrys
{
    public AusCreationEntrys()
    {
        ...
        if (Constants.CanCraftChallengeHelms)
        {
            ...
            new ArmourTemplate(Constants.HHOG_TemplateID, ArmourTemplate.ARMOUR_TYPE_PLATE, 0.0F);
            ...
            new ArmourTemplate(Constants.PHOH_TemplateID, ArmourTemplate.ARMOUR_TYPE_PLATE, 0.0F);
        }
        ...
        if (Constants.CanCraftCrowns)
        {
            ...
            new ArmourTemplate(Constants.JKC_TemplateID, ArmourTemplate.ARMOUR_TYPE_PLATE, 0.0F);
            ...
            new ArmourTemplate(Constants.MRC_TemplateID, ArmourTemplate.ARMOUR_TYPE_PLATE, 0.0F);
            ...
            new ArmourTemplate(Constants.BLC_TemplateID, ArmourTemplate.ARMOUR_TYPE_PLATE, 0.0F);
        }
        if (Constants.CanCraftMockArtifacts)
        {
            ...
            new ArmourTemplate(Constants.COMA_TemplateID, ArmourTemplate.ARMOUR_TYPE_PLATE, 0.0F);
        ...
        if (Constants.CanCraftFancys)
        {
            ...
            new ArmourTemplate(Constants.SummerHat_TemplateID, ArmourTemplate.ARMOUR_TYPE_PLATE, 0.0F);
        ...
        if (Constants.CanCraftCavHelm)
        {
            ...
            new ArmourTemplate(Constants.CavalierHelmetTemplateID, ArmourTemplate.ARMOUR_TYPE_PLATE, 0.0F);
        }
