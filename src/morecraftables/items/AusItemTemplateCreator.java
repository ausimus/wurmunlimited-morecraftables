    ...
    public AusItemTemplateCreator() {
        try {
            ...
            ItemTemplateCreator.createItemTemplate(Constants.HOTA_DeerTemplateID, "Deer hota statue", "statues", "almost full", "somewhat occupied", "half-full", "emptyish", "This statue is the prize of a Hota tournament.",
                    new short[]{108, 22, 51, 52, 92, 1, 32, 176, 199, 178, 44}, (short) 60, (short) 1, 0, 12096000L, 40, 40, 260, -10, MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY, "model.decoration.statue.hota.deer.", Constants.HOTAStatue_CraftingDifficulty, 150000, (byte) 7);
            //Bear fighting Pig
            ItemTemplateCreator.createItemTemplate(Constants.HOTA_BearfightingBullTemplateID, "Bear and Bull hota statue", "statues", "almost full", "somewhat occupied", "half-full", "emptyish", "This statue is the prize of a Hota tournament.",
                    new short[]{108, 22, 51, 52, 92, 1, 32, 176, 199, 178, 44}, (short) 60, (short) 1, 0, 12096000L, 40, 40, 260, -10, MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY, "model.decoration.statue.hota.bearfightingbull.", Constants.HOTAStatue_CraftingDifficulty, 150000, (byte) 7);
            //Dog Fighting Boar
            ItemTemplateCreator.createItemTemplate(Constants.HOTA_DogFightingBoarTemplateID, "Dog and Pig hota statue", "statues", "almost full", "somewhat occupied", "half-full", "emptyish", "This statue is the prize of a Hota tournament.",
                    new short[]{108, 22, 51, 52, 92, 1, 32, 176, 199, 178, 44}, (short) 60, (short) 1, 0, 12096000L, 40, 40, 260, -10, MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY, "model.decoration.statue.hota.dogsfightingboar.", Constants.HOTAStatue_CraftingDifficulty, 150000, (byte) 7);
            ...
            ItemTemplateCreator.createItemTemplate(Constants.HOTA_FemaleFightingAnacondaTemplateID, "Woman and Snake hota statue", "statues", "almost full", "somewhat occupied", "half-full", "emptyish", "This statue is the prize of a Hota tournament.",
                    new short[]{108, 22, 51, 52, 92, 1, 32, 176, 199, 178, 44}, (short) 60, (short) 1, 0, 12096000L, 40, 40, 260, -10, MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY, "model.decoration.statue.hota.femalefightinganaconda.", Constants.HOTAStatue_CraftingDifficulty, 150000, (byte) 7);
            //Lady of The Lake
            ItemTemplateCreator.createItemTemplate(Constants.HOTA_LadyofTheLakeTemplateID, "Lady of The Lake hota statue", "statues", "almost full", "somewhat occupied", "half-full", "emptyish", "This statue is the prize of a Hota tournament.",
                    new short[]{108, 22, 51, 52, 92, 1, 32, 176, 199, 178, 44}, (short) 60, (short) 1, 0, 12096000L, 40, 40, 260, -10, MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY, "model.decoration.statue.hota.ladylake.", Constants.HOTAStatue_CraftingDifficulty, 150000, (byte) 7);
            //Man Fights Bear
            ItemTemplateCreator.createItemTemplate(Constants.HOTA_ManFightingBearTemplateID, "Man and Bear hota statue", "statues", "almost full", "somewhat occupied", "half-full", "emptyish", "This statue is the prize of a Hota tournament.",
                    new short[]{108, 22, 51, 52, 92, 1, 32, 176, 199, 178, 44}, (short) 60, (short) 1, 0, 12096000L, 40, 40, 260, -10, MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY, "model.decoration.statue.hota.manfightingbear.", Constants.HOTAStatue_CraftingDifficulty, 150000, (byte) 7);
            //NoGump
            ItemTemplateCreator.createItemTemplate(Constants.HOTA_NoGumpTemplateID, "Nogump hota statue", "statues", "almost full", "somewhat occupied", "half-full", "emptyish", "This statue is the prize of a Hota tournament.",
                    new short[]{108, 22, 51, 52, 92, 1, 32, 176, 199, 178, 44}, (short) 60, (short) 1, 0, 12096000L, 40, 40, 260, -10, MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY, "model.decoration.statue.hota.nogump.", Constants.HOTAStatue_CraftingDifficulty, 150000, (byte) 7);
            //Scorpion
            ItemTemplateCreator.createItemTemplate(Constants.HOTA_ScorpionTemplateID, "Scorpion hota statue", "statues", "almost full", "somewhat occupied", "half-full", "emptyish", "This statue is the prize of a Hota tournament.",
                    new short[]{108, 22, 51, 52, 92, 1, 32, 176, 199, 178, 44}, (short) 60, (short) 1, 0, 12096000L, 40, 40, 260, -10, MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY, "model.decoration.statue.hota.scorpion.", Constants.HOTAStatue_CraftingDifficulty, 150000, (byte) 7);
            //Sol Demon
            ItemTemplateCreator.createItemTemplate(Constants.HOTA_SolDemonTemplateID, "Sol Demon hota statue", "statues", "almost full", "somewhat occupied", "half-full", "emptyish", "This statue is the prize of a Hota tournament.",
                    new short[]{108, 22, 51, 52, 92, 1, 32, 176, 199, 178, 44}, (short) 60, (short) 1, 0, 12096000L, 40, 40, 260, -10, MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY, "model.decoration.statue.hota.soldemon.", Constants.HOTAStatue_CraftingDifficulty, 150000, (byte) 7);
            //Wolf Fights Bison
            ItemTemplateCreator.createItemTemplate(Constants.HOTA_WolfFightingBisonTemplateID, "Wolf and Bison hota statue", "statues", "almost full", "somewhat occupied", "half-full", "emptyish", "This statue is the prize of a Hota tournament.",
                    new short[]{108, 22, 51, 52, 92, 1, 32, 176, 199, 178, 44}, (short) 60, (short) 1, 0, 12096000L, 40, 40, 260, -10, MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY, "model.decoration.statue.hota.wolffightingbison.", Constants.HOTAStatue_CraftingDifficulty, 150000, (byte) 7);
            //Black Dragon
            ItemTemplateCreator.createItemTemplate(Constants.HOTA_DragonTemplateID, "Dragon hota statue", "statues", "almost full", "somewhat occupied", "half-full", "emptyish", "This statue is the prize of a Hota tournament.",
                    new short[]{108, 22, 51, 52, 92, 1, 32, 176, 199, 178, 44}, (short) 60, (short) 1, 0, 12096000L, 40, 40, 260, -10, MiscConstants.EMPTY_BYTE_PRIMITIVE_ARRAY, "model.decoration.statue.hota.blackdragon.", Constants.HOTAStatue_CraftingDifficulty, 150000, (byte) 7);
            //Gnomes
